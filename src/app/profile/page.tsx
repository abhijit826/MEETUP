...
export default function ProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-gray-900 flex flex-col font-sans pb-24 md:pb-12">
      {/* Navigation Header */}
      <Navbar userEmail={sessionEmail} userFullName={sessionName} />

      {/* Toast Alert */}
      {toastMessage && (
        <div className="fixed top-24 right-5 z-50 px-5 py-3 rounded-2xl bg-gray-900 text-white text-xs font-bold shadow-2xl flex items-center gap-2 animate-fade-in">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 flex-1 w-full space-y-6">
        {/* HERO PROFILE CARD */}
        <section className="relative overflow-hidden rounded-3xl bg-white border border-gray-200/80 shadow-xl">
          {/* Decorative Gradient Header Banner */}
          <div className="h-36 sm:h-48 bg-gradient-to-r from-purple-600 via-pink-600 to-indigo-600 relative overflow-hidden">
          ...
          <div className="px-6 pb-6 pt-0 relative flex flex-col sm:flex-row sm:items-end justify-between gap-4 -mt-16 sm:-mt-20">
            ...
            <div className="flex flex-col sm:flex-row items-center sm:items-end gap-4 text-center sm:text-left">
              ...
              <motion.div
                ...
                className="w-28 h-28 sm:w-32 sm:h-32 rounded-3xl bg-gradient-to-tr from-purple-700 via-indigo-600 to-pink-500 text-white font-black text-4xl sm:text-5xl flex items-center justify-center border-4 border-white shadow-2xl shrink-0"
              >
                {initial}
              </motion.div>
              ...
              <div className="space-y-1 pb-1">
                ...
                <p className="text-xs sm:text-sm font-semibold text-gray-500 flex items-center justify-center sm:justify-start gap-1.5">
                  <School size={14} className="text-purple-600 shrink-0" />
                  <span>{college}</span>
                </p>
            ...
            <div className="flex items-center justify-center sm:justify-end gap-3 pt-2 sm:pt-0">
              <div className="px-4 py-2.5 rounded-2xl bg-amber-50 border border-amber-200 text-amber-900 flex items-center gap-3 shadow-sm">
        ...
        <section className="grid grid-cols-2 md:grid-cols-4 gap-3.5 sm:gap-4">
          <Link href="/messages" className="group">
            <motion.div
              whileHover={{ y: -3 }}
              className="p-4 rounded-2xl bg-white border border-gray-200/70 shadow-sm hover:shadow-md transition-all flex items-center gap-3"
            >
              ...
              <div className="min-w-0">
                <p className="text-xs font-bold text-gray-400 uppercase tracking-wider">Direct DMs</p>
                <p className="text-sm font-black text-gray-900 truncate">Active Chats</p>
              </div>
            </motion.div>
          </Link>
          ...
          <Link href="/meetups" className="group">
            <motion.div
              ...
              className="p-4 rounded-2xl bg-white border border-gray-200/70 shadow-sm hover:shadow-md transition-all flex items-center gap-3"
            >
              <div className="w-10 h-10 rounded-xl bg-purple-50 text-purple-600 flex items-center justify-center group-hover:bg-purple-600 group-hover:text-white transition-all shrink-0">
                <Users size={18} />
              </div>
              <div className="min-w-0">
                <p className="text-xs font-bold text-gray-400 uppercase tracking-wider">Meetup Squads</p>
                <p className="text-sm font-black text-gray-900 truncate">Campus Events</p>
              </div>
            </motion.div>
          </Link>
          ...
          <Link href="/confessions" className="group">
            <motion.div
              ...
              className="p-4 rounded-2xl bg-white border border-gray-200/70 shadow-sm hover:shadow-md transition-all flex items-center gap-3"
            >
              <div className="w-10 h-10 rounded-xl bg-pink-50 text-pink-600 flex items-center justify-center group-hover:bg-pink-600 group-hover:text-white transition-all shrink-0">
                <Heart size={18} />
              </div>
              <div className="min-w-0">
                <p className="text-xs font-bold text-gray-400 uppercase tracking-wider">Confessions</p>
                <p className="text-sm font-black text-gray-900 truncate">Feed Posts</p>
              </div>
            </motion.div>
          </Link>
          ...
          <Link href="/radar" className="group">
            <motion.div
              ...
              className="p-4 rounded-2xl bg-white border border-gray-200/70 shadow-sm hover:shadow-md transition-all flex items-center gap-3"
            >
              <div className="w-10 h-10 rounded-xl bg-indigo-50 text-indigo-600 flex items-center justify-center group-hover:bg-indigo-600 group-hover:text-white transition-all shrink-0">
                <Compass size={18} />
              </div>
              <div className="min-w-0">
                <p className="text-xs font-bold text-gray-400 uppercase tracking-wider">Campus Radar</p>
                <p className="text-sm font-black text-gray-900 truncate">Live Nearby</p>
              </div>
            </motion.div>
          </Link>
        </section>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-white rounded-3xl p-6 border border-gray-200/80 shadow-md space-y-6">
            <div className="flex items-center justify-between border-b border-gray-100 pb-4">
              <div className="flex items-center gap-2">
                <Edit3 size={18} className="text-purple-600" />
                <h2 className="text-lg font-black text-gray-900">Personal Account Info</h2>
              </div>
              <span className="text-xs font-semibold text-gray-400">Public & Campus Profile</span>
            </div>
            ...
            <form onSubmit={handleSaveProfile} className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm font-medium focus:ring-2 focus:ring-purple-500 focus:outline-none bg-slate-50/50"
                  />
                </div>
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  value={sessionEmail}
                  disabled
                  className="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm font-medium text-gray-500 bg-gray-100/70 cursor-not-allowed"
                />
              </div>
              ...
              <div className="space-y-1">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm font-medium focus:ring-2 focus:ring-purple-500 focus:outline-none bg-slate-50/50 resize-none"
                />
              </div>

              {/* Interests & Tags Picker */}
              <div className="space-y-2 pt-2">
                <label className="text-xs font-extrabold text-gray-700 uppercase tracking-wider flex items-center gap-1">
              ...
              <div className="pt-3">
                <motion.button
                  ...
                  type="submit"
                  disabled={isSaving}
                  className="w-full sm:w-auto px-6 py-3 rounded-2xl bg-gradient-to-r from-purple-600 to-indigo-600 text-white text-xs font-extrabold shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-2"
                >
                  <Zap size={16} />
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-3xl p-5 border border-gray-200/80 shadow-md space-y-4">
              ...
              <div className="space-y-2">
                <Link
                  href="/loveguru"
                  className="p-3 rounded-2xl bg-pink-50/70 hover:bg-pink-100/70 border border-pink-100 transition-all flex items-center justify-between text-pink-900 group"
                >
                ...
                <Link
                  href="/messages"
                  className="p-3 rounded-2xl bg-blue-50/70 hover:bg-blue-100/70 border border-blue-100 transition-all flex items-center justify-between text-blue-900 group"
                >
                  <div className="flex items-center gap-2.5">
                ...
                <Link
                  href="/meetups"
                  className="p-3 rounded-2xl bg-purple-50/70 hover:bg-purple-100/70 border border-purple-100 transition-all flex items-center justify-between text-purple-900 group"
                >
                  <div className="flex items-center gap-2.5">
            ...
            <div className="bg-red-50/60 rounded-3xl p-5 border border-red-100 shadow-sm space-y-3">
              <div>
              ...
              <motion.button
                ...
                className="w-full py-2.5 px-4 rounded-xl bg-red-600 hover:bg-red-700 text-white text-xs font-extrabold shadow-sm transition-all flex items-center justify-center gap-2"
              >
                <LogOut size={14} />
