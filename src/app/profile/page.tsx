...
export default function ProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-slate-100/70 dark:bg-slate-950 text-slate-900 dark:text-slate-100 flex flex-col font-sans pb-24 md:pb-12 transition-colors duration-200">
      {/* Navigation Header */}
      <Navbar userEmail={sessionEmail} userFullName={sessionName} />

      {/* Toast Alert */}
      {toastMessage && (
        <div className="fixed top-24 right-5 z-50 px-5 py-3 rounded-2xl bg-slate-900 dark:bg-slate-800 text-white text-xs font-bold shadow-2xl flex items-center gap-2 animate-fade-in border border-slate-700">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 flex-1 w-full space-y-6">
        {/* HERO PROFILE CARD */}
        <section className="relative overflow-hidden rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-lg transition-colors">
          {/* Cover Banner */}
          <div className="h-36 sm:h-48 bg-gradient-to-r from-slate-900 via-slate-800 to-blue-950 dark:from-slate-950 dark:via-blue-950 dark:to-slate-900 relative overflow-hidden">
          ...
          <div className="px-6 pb-6 pt-0 relative flex flex-col sm:flex-row sm:items-end justify-between gap-4 -mt-16 sm:-mt-20">
            ...
            <div className="flex flex-col sm:flex-row items-center sm:items-end gap-4 text-center sm:text-left">
              <motion.div
                ...
                className="w-28 h-28 sm:w-32 sm:h-32 rounded-3xl bg-gradient-to-tr from-slate-950 via-slate-900 to-blue-900 text-white font-black text-4xl sm:text-5xl flex items-center justify-center border-4 border-white dark:border-slate-900 shadow-xl shrink-0"
              >
                {initial}
              </motion.div>
            ...
            <div className="flex items-center justify-center sm:justify-end gap-3 pt-2 sm:pt-0">
              <div className="px-4 py-2.5 rounded-2xl bg-amber-50/90 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-800/60 text-amber-900 dark:text-amber-200 flex items-center gap-3 shadow-xs">
                ...
                <div>
                  <div className="flex items-center gap-1">
                    <span className="text-lg font-black text-amber-900 dark:text-amber-200">{userPoints}</span>
                    <span className="text-[10px] font-bold uppercase text-amber-700 dark:text-amber-400">Pts</span>
                  </div>
                  <p className="text-[10px] font-bold text-amber-600 dark:text-amber-400">Campus Rewards Rank</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="grid grid-cols-2 md:grid-cols-4 gap-3.5 sm:gap-4">
          <Link href="/messages" className="group">
            <motion.div
              whileHover={{ y: -3 }}
              className="p-4 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-xs hover:shadow-md transition-all flex items-center gap-3"
            >
              <div className="w-10 h-10 rounded-xl bg-slate-100 dark:bg-slate-800 text-slate-800 dark:text-slate-200 flex items-center justify-center group-hover:bg-slate-900 dark:group-hover:bg-slate-100 group-hover:text-white dark:group-hover:text-slate-900 transition-all shrink-0">
                <MessageSquare size={18} />
              </div>
              <div className="min-w-0">
                <p className="text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider">Direct DMs</p>
                <p className="text-sm font-black text-slate-900 dark:text-white truncate">Active Chats</p>
              </div>
            </motion.div>
          </Link>
          ...
          <Link href="/meetups" className="group">
            ...
            >
              ...
              <div className="min-w-0">
                <p className="text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider">Meetup Squads</p>
                <p className="text-sm font-black text-slate-900 dark:text-white truncate">Campus Events</p>
              </div>
            </motion.div>
          </Link>
          ...
          <Link href="/confessions" className="group">
            ...
            >
              ...
              <div className="min-w-0">
                <p className="text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider">Confessions</p>
                <p className="text-sm font-black text-slate-900 dark:text-white truncate">Feed Posts</p>
              </div>
            </motion.div>
          </Link>
          ...
          <Link href="/radar" className="group">
            ...
            >
              ...
              <div className="min-w-0">
                <p className="text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider">Campus Radar</p>
                <p className="text-sm font-black text-slate-900 dark:text-white truncate">Live Nearby</p>
              </div>
            </motion.div>
          </Link>
        </section>
          ...
          <div className="lg:col-span-2 bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200 dark:border-slate-800 shadow-sm space-y-6">
            <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-4">
              <div className="flex items-center gap-2">
                <Edit3 size={18} className="text-slate-800 dark:text-slate-200" />
                <h2 className="text-lg font-black text-slate-900 dark:text-white">Personal Account Info</h2>
              </div>
              <span className="text-xs font-semibold text-slate-400 dark:text-slate-500">Public & Campus Profile</span>
            </div>
            ...
            <form onSubmit={handleSaveProfile} className="space-y-4">
              ...
              <div className="space-y-2 pt-2">
                <label className="text-xs font-extrabold text-slate-700 dark:text-slate-300 uppercase tracking-wider flex items-center gap-1">
                  <Tag size={12} className="text-slate-800 dark:text-slate-200" />
              ...
              <div className="pt-3">
                <motion.button
                  ...
                  type="submit"
                  disabled={isSaving}
                  className="w-full sm:w-auto px-6 py-3 rounded-2xl bg-gradient-to-r from-slate-900 via-slate-800 to-blue-950 dark:from-slate-100 dark:to-slate-300 dark:text-slate-900 text-white text-xs font-extrabold shadow-md hover:shadow-lg transition-all flex items-center justify-center gap-2"
                >
                  <Zap size={16} />
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-slate-900 rounded-3xl p-5 border border-slate-200 dark:border-slate-800 shadow-sm space-y-4">
              ...
              <div className="space-y-2">
                <Link
                  href="/loveguru"
                  className="p-3 rounded-2xl bg-slate-100/80 dark:bg-slate-800/60 hover:bg-slate-200/80 dark:hover:bg-slate-800 border border-slate-200 dark:border-slate-700 transition-all flex items-center justify-between text-slate-900 dark:text-slate-100 group"
                >
                  <div className="flex items-center gap-2.5">
                    <Sparkles size={16} className="text-slate-800 dark:text-slate-200" />
                    <span className="text-xs font-extrabold">Ask Guru Ji AI</span>
                  </div>
                  <ChevronRight size={14} className="group-hover:translate-x-1 transition-transform text-slate-500 dark:text-slate-400" />
                </Link>
                ...
                >
                  <div className="flex items-center gap-2.5">
                    <MessageSquare size={16} className="text-slate-800 dark:text-slate-200" />
            ...
            <div className="bg-red-50/60 dark:bg-red-950/30 rounded-3xl p-5 border border-red-100 dark:border-red-900/40 shadow-xs space-y-3">
              <div>
                <h4 className="text-xs font-black text-red-900 dark:text-red-300">Session & Security</h4>
                <p className="text-[11px] text-red-700/80 dark:text-red-400/80 font-medium">
              ...
              <motion.button
                ...
                className="w-full py-2.5 px-4 rounded-xl bg-red-600 dark:bg-red-700 hover:bg-red-700 dark:hover:bg-red-600 text-white text-xs font-extrabold shadow-xs transition-all flex items-center justify-center gap-2"
              >
                <LogOut size={14} />
